          ...
          <li>
            ...
            <div class="side collapse" id="llayouts">
              <ul class="side navbar-nav ps-3">
                ...
                <li>
                  <a href="ikan_lele.php" class="side nav-link px-3">
                    <span class="mdi mdi-fish mdi-light"></span>
  ...
  <main class="mt-5 pt-3">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <br>
          <h4>Pemantauan Ikan Lele</h4>
          <br>
          <!-- Alert Ph -->
          <?php $queryph = mysqli_query($conn, "SELECT * FROM tb_ph WHERE id_ikan = 2 ORDER BY id DESC LIMIT 1");
          ...
          <!-- Alert Tinggi Air -->
          <?php $querytinggi = mysqli_query($conn, "SELECT * FROM tb_tinggi_air WHERE id_ikan = 2 ORDER BY id_tinggi_air DESC LIMIT 1");
          while ($fetch1 = mysqli_fetch_array($querytinggi)){
            $nilaitinggi = $fetch1['tinggi_air'];
          } ?>
          <?php if ($nilaitinggi > 45) { ?>
          <div class="alert alert-danger alert-dismissible fade show" role="alert">
          ...
          <!-- Alert Suhu -->
          <?php $querysuhu = mysqli_query($conn, "SELECT * FROM tb_suhu WHERE id_ikan = 2 ORDER BY id_suhu DESC LIMIT 1");
              ...
              <div class="overview__inner">
                <div class="overview-box clearfix">
                  ...
                  <div class="text">
                    <span>PH Air</span>
                    <h2>
                      <?php $result1 = mysqli_query($conn, "SELECT * FROM tb_ph WHERE id_ikan = 2 ORDER BY id DESC LIMIT 1"); ?>
              ...
              <div class="overview__inner">
                <div class="overview-box clearfix">
                  ...
                  <div class="text">
                    ...
                    <h2>
                      <?php $result2 = mysqli_query($conn, "SELECT * FROM tb_tinggi_air WHERE id_ikan = 2 ORDER BY id_tinggi_air DESC LIMIT 1"); ?>
              ...
              <div class="overview__inner">
                <div class="overview-box clearfix">
                  ...
                  <div class="text">
                    <span>Suhu Air</span>
                    <h2>
                      <?php $result = mysqli_query($conn, "SELECT * FROM tb_suhu WHERE id_ikan = 2 ORDER BY id_suhu DESC LIMIT 1"); ?>
            ...
            <div class="modal-dialog modal-sm" role="document">
              <div class="modal-content">
                ...
                <form action="prosesinputph.php" method="post" style="margin-left: 10px; margin-right: 10px">
                  <div class="mt-2">
                    <?php $result = mysqli_query($conn, "SELECT * FROM tb_ph WHERE id_ikan = 2 ORDER BY id DESC LIMIT 1"); ?>
                      <?php foreach ($result as $row) : ?>
            ...
            <div class="modal-dialog modal-sm" role="document">
              <div class="modal-content">
                ...
                <form action="prosesinputtinggiair.php" method="post" style="margin-left: 10px; margin-right: 10px">
                  <div class="mt-2">
                    <?php $result = mysqli_query($conn, "SELECT * FROM tb_tinggi_air WHERE id_ikan = 2 ORDER BY id_tinggi_air DESC LIMIT 1"); ?>
                    <?php foreach ($result as $row) : ?>
                      <label for="" class="form-label">ID</label>
